...
public class LaptopNoteBooksPageObject extends Base {
	...
	public String successMessageCompare() {
		String actualResult = "Success: You have added " + compareSuccsessMessage.getText()
	...
	public String messageWishList() {
		String actualResult = "You must login or create an account to save " + sonyVaioMessage.getText()
				+ " to your wish list!";
		return actualResult;
	}
